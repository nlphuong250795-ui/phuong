...
<div class="main-header">
    ...
    <p>Tác giả: Ngô Lan Phương - Trường Tiểu học Ngọc Hội - ĐT: 091 7376 410</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Ngô Lan Phương - Trường Tiểu học Ngọc Hội - ĐT: 091 7376 410</div>", unsafe_allow_html=True)
